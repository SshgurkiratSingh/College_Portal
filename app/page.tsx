                ...
                {currentUser ? (
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="flex items-center mb-4">
                        <div className="bg-indigo-100 p-3 rounded-lg mr-4">
                          <svg className="w-6 h-6 text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" /> 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" />
                          </svg>
                        </div>
                    ...
                    <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100 hover:shadow-xl transition-shadow">
                      ...
                      <p className="text-gray-600 mb-6">Track assignments, quizzes, and examinations</p>
                      <ButtonToPage 
                    ...
                    <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100 hover:shadow-xl transition-shadow">
                      <div className="flex items-center mb-4">
                        ...
                        <h3 className="text-xl font-semibold text-gray-900">Assessment Tracking</h3>
                      </div>
                      <p className="text-gray-600 mb-6">Monitor attendance and internal assessments</p>
                      <ButtonToPage 
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {[
                      { 
                        ...
                        description: "Track multiple assessment types: Sessionals (30 marks), Finals (50 marks), Assignments and Quizzes",
                        icon: "M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4"
                      },
                      { 
                        title: "Question-Level Analytics", 
                        description: "Detailed scoring analysis per question with course outcome mapping",
                        icon: "M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"
                      },
                      { 
                        title: "Program Outcome Integration", 
                        description: "Advanced mapping system for PO1-12 and PSO1-3 with automated tracking",
                        icon: "M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"
                      },
                      { 
                        title: "Student Management", 
                        description: "Complete student lifecycle management with batch/section organization and mass data upload",
                  ...
                  <div className="space-y-4">
                    <div className="border-b border-gray-200 pb-4">
                      <div className="flex items-start">
                        ...
                        <div>
                          <h3 className="font-medium text-gray-900">Project Question Scoring</h3>
                          <p className="text-sm text-gray-600 mt-1">
                            Track individual question scores with CO mapping for deeper insights
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="border-b border-gray-200 pb-4">
                      <div className="flex items-start">
                        ...
                        <div>
                          <h3 className="font-medium text-gray-900">Internal Assessment System</h3>
                          <p className="text-sm text-gray-600 mt-1">
                            Streamlined attendance and internal marks tracking
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div>
                      <div className="flex items-start">
                        <div className="bg-purple-100 text-purple-800 text-xs font-medium px-2 py-1 rounded-full mr-3">
                          Updated
                        </div>
                        <div>
                          <h3 className="font-medium text-gray-900">Outcome Integration</h3>
                          <p className="text-sm text-gray-600 mt-1">
                            Complete PO/PSO mapping system with automated tracking and analysis
                          </p>
                        </div>
                      </div>
                    </div>
